...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=1 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    train.py --id train_id_001 --crop_image 1 --use_velocity 1 --seed 2 --epochs 1 --batch_size 5 --lr 1.875e-4 --setting all \
    --root_dir /home/atsushi/DriveLM/pdm_lite/log_root \
    --logdir /home/atsushi/carla_garage/team_code/pretrained_models/all_towns \
    --use_controller_input_prediction 1 --use_wp_gru 0 --use_discrete_command 1 --use_tp 1 --tp_attention 0 --continue_epoch 0 --load_file /home/atsushi/carla_garage/team_code/pretrained_models/all_towns/model_0030_2.pth \
