...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=1 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    train.py --id train_id_006_plant_all_scenario_with_model --use_disk_cache 1 --seed 2 --epochs 47 --batch_size 5 --lr 0.0003 --setting all \
    --root_dir /mnt/ssd/carla_garage/data_selected \
    --logdir /mnt/ssd/carla_garage/team_code/pretrained_models/all_towns \
    --load_file /mnt/ssd/carla_garage/team_code/pretrained_models/all_towns/train_id_006_plant_50scenario_with_model/model_0046.pth \
    --use_controller_input_prediction 0 --use_wp_gru 1 --continue_epoch 0  \
    ...
    # --root_dir /mnt/ssd/DriveLM/pdm_lite/log_root \
