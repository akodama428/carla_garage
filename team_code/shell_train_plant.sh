...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=1 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    train.py --id train_id_006_plant_50scenario_with_model --use_disk_cache 1 --seed 2 --epochs 47 --batch_size 5 --lr 0.0003 --setting all \
    --root_dir /home/atsushi/carla_garage/data_selected \
    --logdir /home/atsushi/carla_garage/team_code/pretrained_models/all_towns \
    --load_file /home/atsushi/carla_garage/team_code/pretrained_models/all_towns/train_id_006_plant_25scenario_with_model/model_0046.pth \
